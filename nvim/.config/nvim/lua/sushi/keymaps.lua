-- This file is automatically loaded by sushi.plugins.config
...
-- map("n", "<leader>fb", vim.cmd.Git, { desc = "Fuzzy search browser bookmarks" })
...
-- toggle options
map("n", "<leader>uf", require("sushi.plugins.lsp.format").toggle, { desc = "Toggle format on Save" })
...
-- next greatest remap ever : asbjornHaland (yanks to clipboard)
...
-- Toggle Term
map("n", "<leader>t", vim.cmd.ToggleTerm, { desc = "Toggle Term" })
